...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const mk = (el, type, labels, data, label, opts = {}) => new Chart(el, {
    ...
    options: Object.assign({ responsive:true, maintainAspectRatio:false, scales: (type==='pie'?'':{y:{beginAtZero:true}}) }, opts)
  });

  mk(document.getElementById('categoryRevenueChart'), 'bar',  catLabels,  catRevenue,  'Doanh thu (VNĐ)');
  mk(document.getElementById('revenueByDateChart'),  'line', revDateLabels, revDateData, 'Doanh thu (VNĐ)', {elements:{line:{tension:0.3}}, datasets:{fill:true}});
